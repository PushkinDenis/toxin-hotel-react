...
import { Checkbox as CheckboxMui, StyledEngineProvider, SvgIcon } from "@mui/material";
          ...
          icon={
            <SvgIcon>
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                <rect x="0.5" y="0.615234" width="19" height="19" rx="3.5" fill="white" stroke="#1F204140" />
              </svg>
            </SvgIcon>
          }
          checkedIcon={
